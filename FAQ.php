...
<html lang="ar" dir="rtl">
	...
	<body>
		...
		<div class="wrapper bg-white rounded shadow">
			<div class="h2 text-center fw-bold">FAQ</div>
			<div class="h3 text-primary text-center" style="color:#a1887f !important">كيف يمكننا مساعدتك </div>
					...
					<div
						...
						<div class="accordion-body p-0">
							<ul class="list-unstyled m-0">
								<li>لحج والعمرة هما ركنان من أركان الإسلام، ويتميز الحج بأنه يحدث في أوقات محددة من العام ويتضمن فريضة الإقامة بعرفة، بينما يمكن أداء العمرة في أي وقت من العام.</li>
